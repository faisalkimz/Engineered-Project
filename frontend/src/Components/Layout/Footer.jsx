...
export default function Footer() {
    ...
    return (
        <footer className="footer">
                ...
                <div className="footer-content">
                    <div className="footer-section">
                        <h3 className="footer-title">
                            Tech<span className="brand-gradient">Mart</span>
                        </h3>
                        <p className="footer-description">
                            Your premium destination for the latest smartphones, laptops, and tech accessories. Shop with confidence.
                        </p>
            ...
            <style jsx="true">{`
                .footer {
                    background: linear-gradient(135deg, hsl(220, 25%, 12%) 0%, hsl(220, 25%, 8%) 100%);
                    color: hsl(220, 15%, 85%);
