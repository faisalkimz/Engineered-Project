...
# Database - SQLite for development by default
DATABASES = {
    'default': {
...
INERTIA_SSR_ENABLED = False  # Set to True when you have SSR setup
...
# CSRF configuration
CSRF_COOKIE_HTTPONLY = False  # Inertia needs to read this
